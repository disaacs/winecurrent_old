  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved wine as @wine" do
        ...
        post :create, {:wine => { "name" => "invalid value" }}, valid_session
        assigns(:wine).should be_a_new(Wine)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested wine" do
        ...
        Wine.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => wine.to_param, :wine => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the wine as @wine" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Wine.any_instance.stub(:save).and_return(false)
        put :update, {:id => wine.to_param, :wine => { "name" => "invalid value" }}, valid_session
        assigns(:wine).should eq(wine)
      end
